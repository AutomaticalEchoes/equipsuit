...
public abstract class BinarySwitchButton extends Button {
    ...
    public BinarySwitchButton(int p_93728_, int p_93729_, int p_93730_, int p_93731_) {
        super(p_93728_, p_93729_, p_93730_, p_93731_, Component.nullToEmpty(null), switchOnPress);
        this.components[0] = Component.nullToEmpty("OFF");
        this.components[1] = Component.nullToEmpty("ON");
    }

    public BinarySwitchButton(int p_93728_, int p_93729_, int p_93730_, int p_93731_, OnTooltip onTooltip) {
        super(p_93728_, p_93729_, p_93730_, p_93731_, Component.nullToEmpty(null), switchOnPress , onTooltip);
        this.components[0] = Component.nullToEmpty("OFF");
        this.components[1] = Component.nullToEmpty("ON");
    }
