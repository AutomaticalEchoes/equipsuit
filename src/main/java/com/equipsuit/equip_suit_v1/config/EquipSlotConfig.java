...
public class EquipSlotConfig {
    ...
    static {
        ...
        EQUIP_SLOT_LIST=BUILDER.comment("add your custom slot nums,make sure  the number exists in your inventory slots list").defineList("equip list", EquipSlotNum ,Integers);
        BUILDER.pop();
        SPEC=BUILDER.build();
    }
}
