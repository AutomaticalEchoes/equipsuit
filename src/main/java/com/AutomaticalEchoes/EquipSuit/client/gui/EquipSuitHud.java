...
public class EquipSuitHud extends Screen implements Widget, EquipSuitHudInterface {
    ...
    private static final Component FOCUS_SUIT_HUD= new TranslatableComponent("focus suit hud");
    ...
    public void renderALl(PoseStack poseStack, int focus) {
        ...
        poseStack.popPose();
        drawString(poseStack, font,new TranslatableComponent(equipSuit.getName()).withStyle(Style.EMPTY)  ,StartX() + 18 , StartY() + 4, stringColor);
    }
