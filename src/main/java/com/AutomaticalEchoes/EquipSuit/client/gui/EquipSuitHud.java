...
public class EquipSuitHud extends Screen implements Widget, EquipSuitHudInterface {
    ...
    private static final Component FOCUS_SUIT_HUD=Component.nullToEmpty("focus suit hud");
    ...
    public void renderSimple(int focus){
        ...
        MutableComponent translatable = new TextComponent(Messages.SUIT_NUM[focus]);
        ...
        if(ModeTipTime > 0){
            drawString(matrixStack, font,Component.nullToEmpty(Messages.TAG_MODE +Messages.MODE_NAME[ChangeMod()])  ,leftPos_0+10,topPos_0-28, 0xFFFFFF);
            ModeTipTime--;
        }
        LastMode = ChangeMod();
    }
    ...
    public void renderALl(int focus){
        ...
        renderMode();
        matrixStack.popPose();
        drawString(matrixStack, font,Component.nullToEmpty(equipSuit.getName())  ,StartX() + 18 , StartY() + 4, stringColor);
    }
