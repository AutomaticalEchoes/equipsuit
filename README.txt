...
—————————————————————————
#默认情况下，第一套装备（I）映射到装备库中的1到4号格,第二组（II）映射到5到,III和IV以此类推.
#不同套装的映射格都用了不同颜色的书签标记（其实不同部位的标记图标也有区别,但是太小了没显示出来,太大了又影响正常使用）
#在你修改格子编号映射之前,确认你的格子没有任何物品.然后再进行修改映射的设置.

#我是个萌新moder,这是我的第一个模组,大家多多海涵.
